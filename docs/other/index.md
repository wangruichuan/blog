...
你写的那些程序，不管是页面的，app，还是小程序，你本地运行的再好，都无法保证在用户的那一侧，仍然能够运行良好。

一般来说，有这么三个方面可以监控：

1. 错误监控：报了哪些错，怎么发生的，什么样的场景下发生的，引发了什么样的错误，甚至这个错误报在哪一行代码
2. 性能监控：用户那边有没有白屏，白屏多少时间，有没有突然出现长时间的卡顿
3. 行为监控：比方说，我们商城软件卖东西，为什么有的用户就买了，有的用户就没买。他进到我们的活动页面，他停留了多少时间，他看的是哪一个版面，又做了哪些操作。

### 数据埋点
数据埋点是服务监控的技术实现。需要在关键的业务代码位置假如一些代码，去收集用户的信息
可以分为两点：
1. 非侵入
2. 侵入
